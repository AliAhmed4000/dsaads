class ServicesController < ApplicationController
  ...
  def custom_offer_create 
    ...
    if @custom.save
      if @custom.by_buyer?
        message_for_seller = "<h4>I can #{@service.title}<span class='pull-right'>$ #{params['price']}</span></h4><a target='_blank' href='#{@service.primary_photo.image_url}'><img class='thumb' src='#{@service.primary_photo.image_url}'></a><p id=#{@custom.id}>#{link_to "Accept",custom_offer_update_path(@custom,'approved'),'class'=>'btn change-color','remote'=>'true'}#{link_to "Reject",custom_offer_update_path(@custom,'rejected'),'class'=>'btn change-color','remote'=>'true'}</p>"
        message_for_buyer = "<h4>I can #{@service.title}<span class='pull-right'>$ #{params['price']}</span></h4><a target='_blank' href='#{@service.primary_photo.image_url}'><img class='thumb' src='#{@service.primary_photo.image_url}'></a><p id=#{@custom.id}>#{link_to "CANCEL OFFER",custom_offer_update_path(@custom,'cancelled'),'remote'=>'true','class'=>'btn change-color' }</p>"
      else
        message_for_buyer = "<h4>I can #{@service.title}<span class='pull-right'>$ #{params['price']}</span></h4><a target='_blank' href='#{@service.primary_photo.image_url}'><img class='thumb' src='#{@service.primary_photo.image_url}'></a><p id=#{@custom.id}>#{link_to "Accept",custom_offer_update_path(@custom,'approved'),'class'=>'btn change-color','remote'=>'true'}#{link_to "Reject",custom_offer_update_path(@custom,'rejected'),'class'=>'btn change-color','remote'=>'true' }</p>"
        message_for_seller = "<h4>I can #{@service.title}<span class='pull-right'>$ #{params['price']}</span></h4><a target='_blank' href='#{@service.primary_photo.image_url}'><img class='thumb' src='#{@service.primary_photo.image_url}'></a><p id=#{@custom.id}>#{link_to "CANCEL OFFER",custom_offer_update_path(@custom,'cancelled'),'remote'=>'true','class'=>'btn change-color' }</p>"
      end
      chat = Chat.create!(
  ...
  def custom_offer_update
    ...
    if package.update_attributes(customstatus: params['status'])
      if package.approved? 
        if package.by_buyer?
          message_for_seller = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Accepted",'javascript:void(0)','class'=>'btn change-color'}</p>"
          ...
          message_for_buyer = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Accepted",show_custom_details_path(package.service,package),:target=>'_blank','class'=>'btn change-color'}</p>"
        ...
        if package.by_buyer?
          message_for_seller = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Rejected",'javascript:void(0)','class'=>'btn change-color'}</p>"
          message_for_buyer = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Sent Rejected",'javascript:void(0)','class'=>'btn change-color' }</p>"
        else
          message_for_buyer = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Rejected",'javascript:void(0)','class'=>'btn change-color'}</p>"
          message_for_seller = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Sent Rejected",'javascript:void(0)','class'=>'btn change-color' }</p>"
        end
        package.chat.update(custom_status: package.customstatus, message_for_seller: message_for_seller,message_for_buyer: message_for_buyer)
      elsif package.cancelled? 
        if package.by_buyer?
          message_for_seller = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Deleted",'javascript:void(0)','class'=>'btn change-color'}</p>"
          message_for_buyer = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Sent Deleted by you",'javascript:void(0)','class'=>'btn change-color' }</p>"
        else
          message_for_buyer = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Deleted",'javascript:void(0)','class'=>'btn change-color'}</p>"
          message_for_seller = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Sent Deleted by you",'javascript:void(0)','class'=>'btn change-color' }</p>"
        end
        package.chat.update(custom_status: package.customstatus, message_for_seller: message_for_seller,message_for_buyer: message_for_buyer)
      end 
    end
