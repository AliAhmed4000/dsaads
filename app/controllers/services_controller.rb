class ServicesController < ApplicationController
  ...
  def custom_offer_create 
    ...
    if @custom.save
      if @custom.by_buyer?
        ...
        message_for_buyer = "<h4>I can #{@service.title}<span class='pull-right'>$ #{params['price']}</span></h4><a target='_blank' href='#{@service.primary_photo.image_url}'><img class='thumb' src='#{@service.primary_photo.image_url}'></a><p id=#{@custom.id}>#{link_to "CANCEL OFFER",show_custom_details_path(@service,@service.custom_packages.last),:target=>'_blank','class'=>'btn change-color' }</p>"
      else
        ...
        message_for_seller = "<h4>I can #{@service.title}<span class='pull-right'>$ #{params['price']}</span></h4><a target='_blank' href='#{@service.primary_photo.image_url}'><img class='thumb' src='#{@service.primary_photo.image_url}'></a><p id=#{@custom.id}>#{link_to "CANCEL OFFER",show_custom_details_path(@service,@service.custom_packages.last),:target=>'_blank','class'=>'btn change-color' }</p>"
      end
      chat = Chat.create!(
  ...
  def custom_offer_update
    ...
    if package.update_attributes(customstatus: params['status'])
      if package.approved? 
        if package.by_buyer?
          message_for_seller = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Accepted by You.",show_custom_details_path(package.service,package),:target=>'_blank','class'=>'btn change-color'}</p>"
          message_for_buyer = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Your Offer Accepted",show_custom_details_path(package.service,package),:target=>'_blank','class'=>'btn change-color' }</p>"
        else
          message_for_buyer = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Accepted by You.",show_custom_details_path(package.service,package),:target=>'_blank','class'=>'btn change-color'}</p>"
          message_for_seller = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Your Offer Accepted",show_custom_details_path(package.service,package),:target=>'_blank','class'=>'btn change-color' }</p>"
        end
        package.chat.update(custom_status: package.customstatus, message_for_seller: message_for_seller,message_for_buyer: message_for_buyer)
          ...
          if package.by_buyer?
            message_for_seller = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Rejected by You.",show_custom_details_path(package.service,package),:target=>'_blank','class'=>'btn change-color'}</p>"
            message_for_buyer = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Your Offer Rejected",show_custom_details_path(package.service,package),:target=>'_blank','class'=>'btn change-color' }</p>"
          else
            message_for_buyer = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Offer Rejected by You.",show_custom_details_path(package.service,package),:target=>'_blank','class'=>'btn change-color'}</p>"
            message_for_seller = "<h4>I can #{package.service.title}<span class='pull-right'>$ #{package.price}</span></h4><a target='_blank' href='#{package.service.primary_photo.image_url}'><img class='thumb' src='#{package.service.primary_photo.image_url}'></a><p>#{link_to "Your Offer Rejected",show_custom_details_path(package.service,package),:target=>'_blank','class'=>'btn change-color' }</p>"
          end
        package.chat.update(custom_status: package.customstatus, message_for_seller: message_for_seller,message_for_buyer: message_for_buyer)
      end 
    end
