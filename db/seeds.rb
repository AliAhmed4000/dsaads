...
banner = user.build_banner(:image => Rails.root.join("app/assets/images/banner.jpg").open,title: "banner",description: "This is my Banner")
banner.save
titles = ["Category1", "Category2", "Category3", "Category4", "Category5", "Category6"]
